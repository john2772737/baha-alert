  ...
  return (
    <div className="bg-slate-800 p-8 rounded-xl shadow-2xl border border-slate-700 w-full max-w-xl mx-auto relative transform transition-all">
      ...
      <p className="text-slate-400 mb-6">
        Enter the phone number (in +E.164 format) and ensure it's verified in
        the Twilio Console to receive critical alerts.
      </p>
              ...
              <article className="p-6 bg-slate-800 rounded-2xl shadow-lg border border-slate-700 hover:border-slate-600 transition-colors flex-grow">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex flex-col items-center group">
                    ...
                    ></canvas>
                    <span className="text-[10px] mt-1 text-slate-400 font-bold uppercase tracking-wide">
                      Rain
                    </span>
                  </div>
                  <div className="flex flex-col items-center group">
