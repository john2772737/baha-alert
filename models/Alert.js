...
// Define the function separately using the standard 'function(next)' syntax 
// to ensure it works correctly and eliminates the 'next is not a function' error.
...
// Attach the hook function to the pre-save event
